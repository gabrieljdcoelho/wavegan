...
if __name__ == "__main__":
    ...
    """
    load data to be used by wavegan
    """
    train_loader = ld.WaveLoader(os.path.join(folder_path, "train"), audio_extension = ".wav")
    valid_loader = ld.WaveLoader(os.path.join(folder_path, "valid"), audio_extension = ".wav")
    """
    build the wavegan
    """
    wave_gan = WaveGan_gp(train_loader, valid_loader)
    wave_gan.train()
